...
int MenadzerAdresata::wczytajAdresatowZalogowanegoUzytkownikaZPliku(int idZalogowanegoUzytkownika)
{
...
void MenadzerAdresata::wyloguj()
{
    adresaci.clear();
}
int MenadzerAdresata::dodajAdresata(int idZalogowanegoUzytkownika, int idOstatniegoAdresata)
{
    Adresat adresat;
...
Adresat MenadzerAdresata::podajDaneNowegoAdresata(int idZalogowanegoUzytkownika, int idOstatniegoAdresata)
{
    Adresat adresat;
...
void MenadzerAdresata::dopiszAdresataDoPliku(Adresat adresat)
{
